...
@section('title', "SitePolicy | himazin331's page")

@section('FB_OGP')
<meta property="og:site_name" content="SitePolicy | himazin331's page" />
<meta property="og:url" content="https://himazin331.com/sitepolicy" />
<meta property="og:title" content="SitePolicy | himazin331's page" />
<meta property="og:description" content="ゆるゆる情報系専門学生himazin331のサイトポリシー"/>
@endsection
@section('TW_OGP')
<meta property="og:url" content="https://himazin331.com/sitepolicy" />
<meta property="og:title" content="SitePolicy | himazin331's page" />
...
@section('content')
<div class="container">
    <div class="content-field" style="padding-top:30px;">
        <h1>サイトポリシー</h1>
        <hr>
        <h3>アクセス解析ツールについて</h3>
        <p>
